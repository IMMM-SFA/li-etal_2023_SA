...
!         eflx_sh_roof            =>   energyflux_inst%eflx_sh_roof_patch             , & ! Output: [real(r8) (:)   ]  roof sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_whiteroof       =>   energyflux_inst%eflx_sh_whiteroof_patch        , & ! Output: [real(r8) (:)   ]  white roof sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_greenroof       =>   energyflux_inst%eflx_sh_greenroof_patch        , & ! Output: [real(r8) (:)   ]  green roof sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_sunwall         =>   energyflux_inst%eflx_sh_sunwall_patch          , & ! Output: [real(r8) (:)   ]  sunwall sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_shadewall       =>   energyflux_inst%eflx_sh_shadewall_patch        , & ! Output: [real(r8) (:)   ]  shadewall sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_improad         =>   energyflux_inst%eflx_sh_improad_patch          , & ! Output: [real(r8) (:)   ]  improad sensible heat flux (W/m**2) [+ to atm] 
!         eflx_sh_perroad         =>   energyflux_inst%eflx_sh_perroad_patch          , & ! Output: [real(r8) (:)   ]  perroad sensible heat flux (W/m**2) [+ to atm] 
...
!            eflx_sh_whiteroof(p)  = eflx_sh_tot(p)         
...
!            eflx_sh_greenroof(p)  = eflx_sh_tot(p)                              
            eflx_lh_greenroof(l)  = eflx_lh_tot(p)
            eflx_gnet_greenroof(l) = eflx_soil_grnd(p) 
!         else if (ctype(c) == icol_sunwall) then
!            eflx_sh_sunwall(p)  = eflx_sh_tot(p)
!         else if (ctype(c) == icol_shadewall) then
!            eflx_sh_shadewall(p)  = eflx_sh_tot(p)
!         else if (ctype(c) == icol_road_imperv) then
!            eflx_sh_improad(p)  = eflx_sh_tot(p)
!         else if (ctype(c) == icol_road_perv) then
!            eflx_sh_perroad(p)  = eflx_sh_tot(p)
         end if
      end do
