...
% load gamma_summer.mat
% load('/Users/danl/Desktop/CESM/regular/heatwave/HW_average.mat')
% 
% variable_to_plot = 6;
% method_to_plot = 2;
...
print(gcf,'-dpng','-r600','Average_autocorrelation_spectrum')
...
% set(gca, 'LineWidth', 1.5)
% 
% print(gcf,'-dpng','-r600','Autocorrelation_histogram')
...
% set(gca, 'LineWidth', 1.5)
% 
% print(gcf,'-dpng','-r600','Average_autocorrelation_spectrum_2')
