function display_latitudinal_dependence(values_input_average, lat_input, x_limit)
...
values_latitudinal_mean = nanmean(values_input_average,1)';
values_latitudinal_std = nanstd(values_input_average,1)';
