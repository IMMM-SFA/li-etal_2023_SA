function display_map_all_positive(values_input_average, value_limit)
...
Color_value = [...
    0.1, 0.2, 0.3, 0.5, 0.7, 1, 1.5, 2]/2*value_limit;
...
set(h,'TickLabels', {'',num2str(Color_value(1)),num2str(Color_value(2)),num2str(Color_value(3)),num2str(Color_value(4)),...
    num2str(Color_value(5)),num2str(Color_value(6)),num2str(Color_value(7)),num2str(Color_value(8)),''})
