function display_map_annual_sig(Values_input_annual, value_limit, sig_matrix)
...
box on 
set(gca, 'Position', [0.1, 0.14, 0.74, 0.82])
...
set(h,'position',[0.86, 0.14, 0.02, 0.82])
set(h,'Ticks', 0:1:15)
...
% plot sig
geoimg2 = geoshow(sig_matrix(:,1), sig_matrix(:,2), 'DisplayType','POINT','Marker','x','Color', 'black', 'MarkerEdgeColor', 'auto','markersize',1);
% geoscatter(sig_matrix(:,1), sig_matrix(:,2))

% plot worldmap
coast = load('coastlines.mat');
geoshow(coast.coastlat, coast.coastlon, 'Color', 'black', 'Linewidth', 0.2)
