...
load('gamma.mat','lambdaminus1_diff_frac','sig_matrix','mask_p_AC');
load('mu_data.mat')
...
plot_value = lambdaminus1_diff_frac;
...
print(gcf,'-dpng','-r600','Spatial_autocorrelation_difference_fraction')
...
% print(gcf,'-dpng','-r600','mu_and_gamma')
